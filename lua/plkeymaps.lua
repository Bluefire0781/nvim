...
vim.keymap.set({"n", "v"}, "<leader>tf", ":ToggleTerm direction=float<CR>", {desc = "Float Terminal"}, { noremap = true, silent = true })
vim.keymap.set({"n", "v"}, "<leader>th", ":ToggleTerm direction=horizontal<CR>", {desc = "Horiz Terminal"}, { noremap = true, silent = true })
vim.keymap.set({"n", "v"}, "<leader>tv", ":ToggleTerm direction=vertical<CR>", {desc = "Verti Terminal"}, { noremap = true, silent = true })
vim.keymap.set({"n", "v"}, "<leader>tb", ":ToggleTerm direction=tab<CR>", {desc = "Tab Terminal"}, { noremap = true, silent = true })
